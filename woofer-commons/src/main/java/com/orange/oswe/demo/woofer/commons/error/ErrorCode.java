...
public enum ErrorCode {
	...
	InternalError(HttpStatus.INTERNAL_SERVER_ERROR, 1),
	/**
	...
	MissingCredentials(HttpStatus.UNAUTHORIZED, 40),
	/**
	...
	InvalidCredentials(HttpStatus.UNAUTHORIZED, 41),
	/**
	...
	ExpiredCredentials(HttpStatus.UNAUTHORIZED, 42),
	/**
	...
	ServiceAccessDenied(HttpStatus.FORBIDDEN, 50),
	/**
	...
	MethodNotSupported(HttpStatus.METHOD_NOT_ALLOWED, 61),
	/**
	...
	MediaTypeNotAcceptable(HttpStatus.NOT_ACCEPTABLE, 62),
	/**
	...
	Success(HttpStatus.OK, 0),
	/**
	 * Unknown bad request error.
	 */
	@Deprecated
	@Doc("Unknown bad request error.")
	BadRequest(HttpStatus.BAD_REQUEST, 1040),
	/**
	...
	ServiceNotFound(HttpStatus.NOT_FOUND, 60),
	/**
	...
	NotImplemented(HttpStatus.NOT_IMPLEMENTED, 1051),
	...
	ResourceNotFound(HttpStatus.NOT_FOUND, 60),
	/**
	...
	ResourceConflict(HttpStatus.CONFLICT, 1091),
	/**
	...
	ResourceAccessDenied(HttpStatus.FORBIDDEN, 50)
	;
